...
Fecha: lunes, 11 de agosto de 2025, 10:21:22 EDT
...
./verificar_actualizaciones.sh:326:        echo -e "   🔄 Ejecuta ${BLUE}sudo ./actualizar_sistema.sh${NC} para actualizar Authentic Theme"
./verificar_actualizaciones.sh:336:        echo -e "   ⚙️  Inicia el servicio Webmin: ${BLUE}sudo systemctl start webmin${NC}"
...
./postfix_validation_functions.sh:107:        echo "💡 Ejecute: sudo apt-get install postfix (Ubuntu/Debian)"
./postfix_validation_functions.sh:108:        echo "💡 Ejecute: sudo yum install postfix (CentOS/RHEL)"
...
./integrar_validaciones_postfix.sh:152:        echo "💡 Ejecute: sudo apt-get install postfix (Ubuntu/Debian)"
./integrar_validaciones_postfix.sh:153:        echo "💡 Ejecute: sudo yum install postfix (CentOS/RHEL)"
...
./analisis_codigo_funciones.sh:292:        # Verificar uso de sudo sin validación
...
./analisis_codigo_funciones.sh:297:                log_warning "Uso de sudo sin validación en $(basename "$script_file")"
...
./instalacion_un_comando.sh:171:        log "INFO" "Uso: sudo $0"
...
./verificacion_completa_funciones.sh:739:        echo "   • sudo ./instalacion_completa_automatica.sh  # Instalación completa"
./verificacion_completa_funciones.sh:740:        echo "   • sudo ./verificacion_final_autonomo.sh      # Verificación completa"
./verificacion_completa_funciones.sh:741:        echo "   • sudo systemctl status webmin               # Estado de Webmin"
./verificacion_completa_funciones.sh:742:        echo "   • sudo systemctl status apache2              # Estado de Apache"
./verificacion_completa_funciones.sh:743:        echo "   • sudo ufw status                            # Estado del firewall"
./verificacion_completa_funciones.sh:744:        echo "   • sudo apt update && sudo apt upgrade        # Actualizar sistema"
...
./activar_ssh_macos.sh:95:echo "  3. Verificar configuración: sudo sshd -T"
...
./instalacion_un_comando.sh:88:        rm -rf "$TEMP_DIR" 2>/dev/null || true
./instalacion_un_comando.sh:307:        rm -rf "$TEMP_DIR"
./instalacion_un_comando.sh:605:            rm -rf "$THEME_DEST"
./instalacion_un_comando.sh:1162:        rm -rf "$TEMP_DIR"
...
./instalacion_un_comando.sh:92:    systemctl start apache2 2>/dev/null || true
./instalacion_un_comando.sh:93:    systemctl start mysql 2>/dev/null || true
./instalacion_un_comando.sh:499:    if systemctl is-active --quiet webmin; then
./instalacion_un_comando.sh:503:        systemctl enable webmin
./instalacion_un_comando.sh:504:        systemctl start webmin
./instalacion_un_comando.sh:506:        if systemctl is-active --quiet webmin; then
./instalacion_un_comando.sh:613:        systemctl restart webmin
./instalacion_un_comando.sh:639:    systemctl enable --now spamassassin >/dev/null 2>&1 || systemctl enable --now spamd >/dev/null 2>&1 || true
./instalacion_un_comando.sh:642:    systemctl enable --now clamav-freshclam >/dev/null 2>&1 || true
./instalacion_un_comando.sh:643:    systemctl enable --now clamav-daemon >/dev/null 2>&1 || true
./instalacion_un_comando.sh:656:    systemctl enable --now opendkim >/dev/null 2>&1 || true
./instalacion_un_comando.sh:684:        systemctl restart postfix >/dev/null 2>&1 || true
./instalacion_un_comando.sh:706:    systemctl enable --now fail2ban >/dev/null 2>&1 || true
./instalacion_un_comando.sh:709:    systemctl enable --now dovecot >/dev/null 2>&1 || true
./instalacion_un_comando.sh:756:    systemctl enable --now redis-server >/dev/null 2>&1 || true
./instalacion_un_comando.sh:757:    systemctl enable --now memcached >/dev/null 2>&1 || true
./instalacion_un_comando.sh:761:    systemctl enable --now php7.4-fpm >/dev/null 2>&1 || true
./instalacion_un_comando.sh:762:    systemctl enable --now php8.1-fpm >/dev/null 2>&1 || true
./instalacion_un_comando.sh:763:    systemctl enable --now php8.2-fpm >/dev/null 2>&1 || true
./instalacion_un_comando.sh:766:    systemctl restart apache2 >/dev/null 2>&1 || true
./instalacion_un_comando.sh:775:    systemctl enable --now webmin >/dev/null 2>&1 || true
./instalacion_un_comando.sh:776:    if systemctl list-unit-files 2>/dev/null | grep -q "^usermin\.service"; then
./instalacion_un_comando.sh:777:        systemctl enable --now usermin >/dev/null 2>&1 || true
./instalacion_un_comando.sh:852:        systemctl restart webmin >/dev/null 2>&1 || true
./instalacion_un_comando.sh:917:    systemctl restart webmin >/dev/null 2>&1 || true
./instalacion_un_comando.sh:918:    systemctl restart usermin >/dev/null 2>&1 || true
./instalacion_un_comando.sh:953:    systemctl restart webmin
./instalacion_un_comando.sh:977:    if systemctl is-active --quiet mysql; then
./instalacion_un_comando.sh:992:            systemctl restart mysql
./instalacion_un_comando.sh:1006:            systemctl restart mysql
./instalacion_un_comando.sh:1014:    if systemctl is-active --quiet apache2; then
./instalacion_un_comando.sh:1035:        systemctl restart apache2
./instalacion_un_comando.sh:1052:        if systemctl is-active --quiet "$service"; then
./instalacion_un_comando.sh:1205:        if ! systemctl is-active --quiet "$service"; then
./instalacion_un_comando.sh:1207:            systemctl restart "$service" || service "$service" restart || true
./instalacion_un_comando.sh:1209:            if systemctl is-active --quiet "$service"; then
